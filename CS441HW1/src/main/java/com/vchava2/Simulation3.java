...
public class Simulation3  {
    ...
    public static Logger LOGGER = LoggerFactory.getLogger(Simulation3.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int brokerId = (int) broker1.getId();
        ...
        networkTopology.addLink(networkDatacenterList.get(0).getId(), broker1.getId(), 1000.0, 10);
        networkTopology.addLink(networkDatacenterList.get(1).getId(), broker1.getId(), 1000.0, 10);

        LOGGER.info("Simulation Started");

        cloudSim.start();

        List<CustomCloudlet> cloudletFinishedList = broker1.getCloudletFinishedList();

        LOGGER.info("Simulation Finished");
        LOGGER.info("+++++++++++++++ OUTPUT (CloudletScheduler: SpaceShared Policy) ++++++++++++");
        ...
        cloudletFinishedList.forEach(Simulation3::displayResult);
    ...
    public static Broker1 createBroker(CloudSim simulation) throws Exception {
        return new Broker1(simulation,"Broker");
    }
    ...
    public static List<Vm> createVMList( int numVM, int  startId, List<Vm> vmList){
        ...
        Vm vm = new VmSimple( mips, pesNum,new CloudletSchedulerSpaceShared());
        vm.setId(startId);
        vm.setRam(ram);
        vm.setBw(bw);
